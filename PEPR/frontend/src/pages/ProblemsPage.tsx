...
export const ProblemsPage: React.FC = () => {
  ...
  const filtered = problems.filter((prob) => {
    const matchesSearch =
      ...
      prob.description.toLowerCase().includes(search.toLowerCase());
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">
            Prioritized economic problems synthesized from 7-day database window analysis (M1-M4), enriched with M5 PIDE Research Showcase publications.
          </p>
        </div>
